...
export default function PrivacyPolicy() {
    return (
        <>
            <Helmet>
                <title>Trucore Technologies | Privacy Policy</title>
                <meta name="description" content="Privacy Policy of Trucore Technologies. Learn how we collect, use, and protect your personal information." />
                <link rel="canonical" href="https://www.trucoretechnology.com/privacy-policy" />
                <meta property="og:title" content="Trucore Technologies | Privacy Policy" />
                <meta property="og:description" content="Privacy Policy of Trucore Technologies." />
                <meta property="og:type" content="website" />
                <meta property="og:url" content="https://www.trucoretechnology.com/privacy-policy" />
                <meta property="og:image" content="https://www.trucoretechnology.com/logo.png" />
            </Helmet>

            <section className="relative min-h-screen pt-32 pb-20 bg-gray-50 overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 max-w-4xl">
                    <div className="bg-white rounded-[2rem] shadow-sm border border-gray-100 p-8 md:p-12">
                        ...
                        <div className="prose prose-blue max-w-none 
                            [&>h1]:text-3xl [&>h1]:md:text-4xl [&>h1]:font-bold [&>h1]:text-gray-900 [&>h1]:mb-6 [&>h1]:mt-8
                            [&>h2]:text-2xl [&>h2]:font-bold [&>h2]:text-gray-900 [&>h2]:mb-4 [&>h2]:mt-8 [&>h2]:border-b [&>h2]:border-gray-100 [&>h2]:pb-2
                            [&>h3]:text-xl [&>h3]:font-bold [&>h3]:text-gray-900 [&>h3]:mb-3 [&>h3]:mt-6
                            [&>h4]:text-lg [&>h4]:font-bold [&>h4]:text-gray-900 [&>h4]:mb-2 [&>h4]:mt-4
                            [&>p]:text-gray-600 [&>p]:leading-relaxed [&>p]:mb-4
                            [&>ul]:list-disc [&>ul]:pl-6 [&>ul]:mb-6 [&>ul]:text-gray-600
                            [&>ul>li]:mb-2 [&>ul>li>p]:mb-1
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Trucore Technologies, 315 Raj Imperia, Surat, Gujarat, India.</p>
</li>
<li>
...
<li>
<p><strong>Website</strong> refers to Trucore Technologies, accessible from <a href="https://www.trucoretechnology.com" target="_blank">www.trucoretechnology.com</a>.</p>
</li>
<li>
...
<ul>
<li>By email: <a href="mailto:contact@trucoretechnology.com">contact@trucoretechnology.com</a></li>
</ul>
`;
